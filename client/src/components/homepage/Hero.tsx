...
export default function Hero(){
    return(
        <div className="flex flex-col justify-center items-center mt-20 gap-6">
            ...
            <div className="flex flex-row gap-1 md:gap-4 border px-4 py-2 rounded-full">
                <input className="md:w-[240px] outline-none text-sm" placeholder="Enter your email address" />
                <Link to={"/login"} className="bg-primary px-4 py-1 rounded-full text-white">
                    <p className="text-sm overflow-ellipsis">Get Started</p>
                </Link>
            </div>            
        </div>
    )
